...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Want to contact me for job opportunities? or simply wanna chat? Send me a mail so we can talk! </p>
      <form name="contact" action="https://formsubmit.co/3d17f441f3b379fb28c95fe92bfc0ef9" method="POST" class="space-y-8">
          <div class="my-4">
